...
export default function TasksHP() {
  ...
  const filteredTasks = useMemo(() => {
    return tasks.filter(task => {
      if (task.division !== "HP" && task.division !== "Both") return false;
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Human-Powered Rover project board"
        actions={
          isAdmin && (
            <Button
